...
# Image imagination
DIGIT = 3
best_image, best_prob = model_processor.imagine_digit(DIGIT, shape=[32, 1, 28, 28])
print(f'Best image probability: {best_prob.item()*100:.2f}%')
visualization.plot_image(best_image, title=f"Best imagined image of digit {DIGIT}", name=f"best_imagined_{DIGIT}")
...
visualization.plot_many_filtered_images(*utils.calculation.get_many_filtered_images(best_image.unsqueeze(0).unsqueeze(0), filters),
